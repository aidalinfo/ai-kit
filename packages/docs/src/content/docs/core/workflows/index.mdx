...
- [`Télémétrie`](./telemetry) : activez les spans OTEL, personnalisez vos traces et connectez Langfuse.
...
- Combinez workflows et agents (`/core/agents/`) pour modéliser des boucles plus complexes.
