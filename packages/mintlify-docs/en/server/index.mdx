...
Want a preconfigured project instead? Run:
...
Use [`@ai_kit/client-kit`](https://www.npmjs.com/package/@ai_kit/client-kit) to reach the server from another Node.js service or edge worker:
